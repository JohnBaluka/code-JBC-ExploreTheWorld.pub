...
{
    // Reads values from Microsoft.Office.Interop COM objects with the same semantics as the
    // VBA JSON writers: a property that throws is written as null. Values are formatted
