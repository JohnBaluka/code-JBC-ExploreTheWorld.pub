...
namespace JBC.ExploreTheWorld.DL.MsOfficeApi.Interop_Impl.JsonWriters
{
    ...
    // Excel workbook (via the strongly-typed Microsoft.Office.Interop object model) and writes it
    ...
    public static class MsExcelJsonWriter
    {
        ...
        private static XL.Sheet BuildWorksheet(Worksheet worksheet)
        {
            ...
            try
            {
                ...
                {
                    Range row = (Range)usedRange.Rows[rowIndex];
                    ...
                    {
                        rowEntity.Cells.Add(BuildCell((Range)row.Cells[1, columnIndex], rowIndex, columnIndex));
                    }
