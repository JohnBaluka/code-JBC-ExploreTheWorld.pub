...
namespace JBC.ExploreTheWorld.AL.MsOfficeExcelVstoAddIn
{
    ...
    [ComVisible(true)]
    [Guid("C2D3E4F5-A6B7-7890-ABCD-EF0123456711")]
    [ProgId("JBC.ExploreTheWorld.AL.MsOfficeExcelVstoAddIn.CountriesNow_TaskPane_UserControl")]
    public partial class CountriesNow_TaskPane_UserControl : UserControl, ITaskPane, IObjectSafety
    {
        ...
        public CountriesNow_TaskPane_UserControl()
        {
            ...
            try
            {
                ...
                inner.EnableAddinExportMode("Excel");
                Controls.Add(inner);
            }
            catch (Exception ex)
            {
