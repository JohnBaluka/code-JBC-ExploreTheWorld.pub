...
namespace JBC.ExploreTheWorld.AL.MsOfficePowerPointVstoAddIn
{
    ...
    [ComVisible(true)]
    [Guid("C3D4E5F6-A7B8-7890-ABCD-EF0123456712")]
    [ProgId("JBC.ExploreTheWorld.AL.MsOfficePowerPointVstoAddIn.CountriesNow_TaskPane_UserControl")]
    public partial class CountriesNow_TaskPane_UserControl : UserControl, ITaskPane, IObjectSafety
    {
        ...
        public CountriesNow_TaskPane_UserControl()
        {
            ...
            try
            {
                ...
                inner.EnableAddinExportMode("PowerPoint");
                Controls.Add(inner);
            }
            catch (Exception ex)
            {
        ...
        public void OnConnection(
            NetOffice.PowerPointApi.Application application,
