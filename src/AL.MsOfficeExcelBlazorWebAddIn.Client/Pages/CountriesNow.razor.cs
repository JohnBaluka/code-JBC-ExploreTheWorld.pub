...
public partial class CountriesNow : ComponentBase
{
    ...
    [Inject]
    private ExcelCountriesExport__Interop__Interface ExportInterop { get; set; } = default!;
    ...
    private async Task ExportToDocumentAsync()
    {
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(result.Error))
                ...
                _exportStatus = $"Wrote {result.Count} countries ({result.FlagCount} flags) to the worksheet.";
        }
