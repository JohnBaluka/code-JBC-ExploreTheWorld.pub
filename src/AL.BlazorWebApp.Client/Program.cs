...
// Blazor Web App WASM companion — service registration only.
// Root component mounting is NOT done here; blazor.web.js hydrates components
// that carry @rendermode="InteractiveWebAssembly" markers in the server HTML.
