...
namespace JBC.ExploreTheWorld.AL.MauiApp.iOS;
...
public static class MauiProgram
{
    public static global::Microsoft.Maui.Hosting.MauiApp CreateMauiApp()
    {
        ...
        global::JBC.ExploreTheWorld.AL.MauiLib.App.AppTitle = "ETW MauiApp.iOS";
        ...
        // iPhone has no MAUI multi-window support — the New Window button is a no-op.
