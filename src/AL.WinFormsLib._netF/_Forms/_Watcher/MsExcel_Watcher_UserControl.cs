...
{
    [ComVisible(true)]
    [Guid("A1B2C3D4-E5F6-7890-ABCD-EF0123456704")]
    /// <summary>
    /// Hosts <see cref="MsExcel_Watcher_Form"/> as a reusable UserControl
    /// so it can be embedded in VSTO Task Panes via ICTPFactory.CreateCTP.
    /// Implements <see cref="ITaskPane"/> so NetOffice injects the running Excel
    ...
    /// </summary>
    public class MsExcel_Watcher_UserControl : UserControl, ITaskPane, IObjectSafety
#if !NETFRAMEWORK
...
#endif
    {
        ...
        private readonly MsExcel_Watcher_Form _form;

        public MsExcel_Watcher_UserControl()
        {
            _form = new MsExcel_Watcher_Form();
        ...
        /// <summary>
        /// Injects a running Excel.Application into the embedded watcher form.
        ...
        public void OnConnection(NetOffice.ExcelApi.Application application, Office._CustomTaskPane parentPane, object[] customArguments)
        {
